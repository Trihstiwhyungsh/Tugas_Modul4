...
public class nomor7_insertionsortsearching {
    ...
    public static void main(String[] args){
        int A[] = {25, 7, 9, 13, 3};
        nomor7_insertionsortsearching.tampil(A);
        nomor7_insertionsortsearching.insertionsort(A);
        nomor7_insertionsortsearching.tampil(A);
        nomor7_insertionsortsearching.sequential(pencarian);
